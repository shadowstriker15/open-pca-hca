<template>
  <div>
    <v-navigation-drawer class="side-nav" width="70" permanent app>
      <v-list dense nav class="py-0">
        ...
        <!-- PCA 2D -->
        <v-list-item title="PCA 2D" link>
          <v-img src="@/assets/icons/PCA-2D-light-good.svg"></v-img>
        </v-list-item>
        <!-- PCA 3D -->
        <v-list-item title="PCA 3D" link>
          <v-img src="@/assets/icons/PCA-2D-light-good.svg"></v-img>
        </v-list-item>
        <v-divider class="pb-1"></v-divider>
        <!-- Dendrogram -->
        <v-list-item title="Dendrogram" link>
          <v-img src="@/assets/icons/PCA-2D-light-good.svg"></v-img>
        </v-list-item>
        <!-- Heatmap -->
        <v-list-item title="Heatmap" link>
          <v-img src="@/assets/icons/PCA-2D-light-good.svg"></v-img>
        </v-list-item>
      </v-list>
