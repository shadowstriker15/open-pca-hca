...
export default Vue.extend({
  ...
  computed: {
    fullscreenTooltip(): string {
      return this.isFullscreen ? "Exit full screen" : "Go full screen";
    },
    settingsTooltip(): string {
      return this.showSettings ? "Close settings" : "Show settings";
    },
  },
  methods: {
    /**
