    ...
    <v-col>
      ...
      <v-row class="ma-3" style="justify-content: center">
        <svg
          ...
          viewBox="0 0 118.6 114.76"
        >
          <g transform="translate(-60.749 -156.82)" fill="currentColor">
            <g transform="matrix(4.4318 0 0 4.4318 18.832 115.81)">
              <path
                transform="matrix(.059702 0 0 .059702 9.4585 9.2519)"
                d="m171.39 0a81.122 81.122 0 00-81.123 81.121 81.122 81.122 0 0081.123 81.123 81.122 81.122 0 0081.121-81.123 81.122 81.122 0 00-81.121-81.121zm185.84 141.05a91.021 91.021 0 00-91.021 91.021 91.021 91.021 0 0091.021 91.021 91.021 91.021 0 0091.021-91.021 91.021 91.021 0 00-91.021-91.021zm-249.07 76.373a108.16 108.16 0 00-108.16 108.16 108.16 108.16 0 00108.16 108.16 108.16 108.16 0 00108.16-108.16 108.16 108.16 0 00-108.16-108.16z"
                stroke-width="16.75"
              />
            </g>
          </g>
